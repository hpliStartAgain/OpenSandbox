...
# Server-injected administrator contract for the root-compatible upstream
# profile; never accepted from a sandbox request.
OPENSANDBOX_EGRESS_PUBLIC_POLICY = "OPENSANDBOX_EGRESS_PUBLIC_POLICY"
OPENSANDBOX_EGRESS_DNS_UPSTREAM = "OPENSANDBOX_EGRESS_DNS_UPSTREAM"
