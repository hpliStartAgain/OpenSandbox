...
#   * The public profiles' `inet opensandbox_public_egress` table MUST survive
#     cleanup/shutdown. The cgroup-v2-root classifier also survives. They
#     enforce fail-closed interception throughout the restart window.
#
